(function () {
    var app = angular.module('myAppSlider', []);

    app.directive('iconSlider', ['$window','$interval','$timeout', function ($window, $interval, $timeout) {
        return {
            require: "ngModel",
            scope: {
                icons_obj: '=icons',
            ...
            templateUrl: '/directives/image-slider/slider.html',
        }
    }]);
})();